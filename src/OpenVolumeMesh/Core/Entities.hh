...
/// EntityTag:
namespace Entity {
struct OVM_EXPORT Vertex   { static constexpr EntityType type() {return EntityType::Vertex;}};
struct OVM_EXPORT Edge     { static constexpr EntityType type() {return EntityType::Edge;}};
struct OVM_EXPORT HalfEdge { static constexpr EntityType type() {return EntityType::HalfEdge;}};
struct OVM_EXPORT Face     { static constexpr EntityType type() {return EntityType::Face;}};
struct OVM_EXPORT HalfFace { static constexpr EntityType type() {return EntityType::HalfFace;}};
struct OVM_EXPORT Cell     { static constexpr EntityType type() {return EntityType::Cell;}};
struct OVM_EXPORT Mesh     { static constexpr EntityType type() {return EntityType::Mesh;}};
} // namespace Entity
